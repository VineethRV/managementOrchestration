...
Just the list, no extra text:"""
    ...
    try:
        ...
        # Track conversation tokens for page listing
        get_tracker().track_conversation(response, "page_listing")
...
JSON array only:"""
        ...
        try:
            ...
            # Track conversation tokens for page requirements
            get_tracker().track_conversation(response, "page_requirements")
...
JSON array only:"""
        ...
        try:
            ...
            # Track conversation tokens for endpoint identification
            get_tracker().track_conversation(response, "endpoint_identification")
            content = response.content.strip().replace("```json", "").replace("```", "").strip()
...
JSON array only:"""
        ...
        try:
            ...
            # Track conversation tokens for API specification
            get_tracker().track_conversation(response, "api_specification")
            content = response.content.strip().replace("```json", "").replace("```", "").strip()
